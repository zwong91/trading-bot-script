...
exports.demonstrateTraderJoeBNBUSDC = demonstrateTraderJoeBNBUSDC;
exports.showAvailableFunctions = showAvailableFunctions;
exports.runTraderJoeDemo = main;
const fs_1 = require("./fs");
// 演示如何使用修复后的TraderJoe BNB-USDC功能
function demonstrateTraderJoeBNBUSDC() {
    return __awaiter(this, void 0, void 0, function* () {
        fs_1.logger.info("🎉 TraderJoe V2.2 BNB-USDC 功能修复成功!");
        console.log("\n" + "=".repeat(60));
        console.log("🔧 修复内容总结:");
   ...
   const txHash = await addLiquidityBNBUSDC(
     ...
     "3.0"     // USDC 数量
        ...
        console.log("\n" + "=".repeat(60));
        fs_1.logger.success("✨ TraderJoe V2.2 BNB-USDC 功能已准备就绪!");
        console.log("=".repeat(60));
    });
}
/**
...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            yield demonstrateTraderJoeBNBUSDC();
